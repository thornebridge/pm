			...
			{#if step === 'date' || step === 'time'}
				<div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
					...
					<div class="mb-3 flex items-center justify-between">
						<button onclick={prevMonth} class="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600">
						...
						<button onclick={nextMonth} class="rounded-lg p-1.5 text-gray-400 hover:bg-gray-100 hover:text-gray-600">
